        ...
        <div className="padding-x max-width mx-auto py-16">
            ...
            <div className="flex flex-col md:flex-row gap-12">
                ...
                <div className="flex flex-col gap-6 md:w-1/2">
                    ...
                    <p className="font-swiss text-black/60 text-sm">
                        by {book?.author}
                    </p>
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input
                            ...
                            className="bg-transparent border-b border-black/30 text-black font-swiss text-sm py-1 outline-none focus:border-black transition-colors"
                        />
                    </div>
                ...
                <div className="flex flex-col gap-4 md:w-1/2">
                    <label className="text-xs uppercase tracking-widest text-black font-swiss">
                        Your Thoughts
                    </label>
                    <textarea
                        value={entry.content}
                        ...
                        rows={16}
                        className="w-full bg-primary-white border p-6 text-black font-swiss text-sm resize-none outline-none transition-colors placeholder:text-black/20"
                    />
                    <button
                        onClick={handleSave}
                        disabled={saving}
